...
class Funcoes:
    ...
    def consulta(iTIPOCONSULTA):

        iTOKEN = "0b922443911c126e4ad10dcdc1cb6f8e"
        iCIDADE = "3618"
        ...
        if iTIPOCONSULTA == 3:
            ...
            #     retorno.append("data: " + str(iDATA) + " chuva: " + str(iCHUVA) + "%" + " temp: min(" + str(iTEMPERATURAMIN) + ") max(" + str(iTEMPERATURAMAX) + ") resumo: " + str(iTEXTMORNING) + "\n")
        ...
        if iTIPOCONSULTA == 4:
            ...
            retorno= ("data: " + str(iDATA) + " texto: " + str(iTEXT) + "\n")
            return retorno
